...
HUD
Jake Rothacker
This file contains the HUD class which creates and updates the heads up display with information from the GameStats class
...
class HUD:
    """Creates and updates the heads up display
    """
    ...
    def _setup_life_image(self):
        """sets up the image that will represent an extra life (does not add it to the HUD)
        """
    ...
    def update_scores(self):
        """updates Hi- Max- and regular scores to the HUD
        """
    ...
    def _update_score(self):
        """updates the regular score to the HUD
        """
    ...
    def _update_max_score(self):
        """updates the max score to the HUD
        """
    ...
    def _update_hi_score(self):
        """updates the hi score to the HUD
        """
    ...
    def _draw_lives(self):
        """draws the curent number of lives left to the HUD
        """
        currennt_x = self.padding
        currennt_y = self.padding
